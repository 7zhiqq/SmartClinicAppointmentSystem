...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('website', '0008_doctorinfo_is_rejected_doctorinfo_rejected_at'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to='website.doctorinfo')),
